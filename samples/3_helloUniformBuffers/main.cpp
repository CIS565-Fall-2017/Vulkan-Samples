...
VkPipeline CreatePipeline(VkPipelineLayout pipelineLayout, VkRenderPass renderPass, unsigned int subpass) {
    VkShaderModule vertShaderModule = createShaderModule("3_helloUniformBuffers/shaders/shader.vert.spv", device->GetVulkanDevice());
    VkShaderModule fragShaderModule = createShaderModule("3_helloUniformBuffers/shaders/shader.frag.spv", device->GetVulkanDevice());
