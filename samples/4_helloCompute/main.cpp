...
VkPipeline CreateGraphicsPipeline(VkPipelineLayout pipelineLayout, VkRenderPass renderPass, unsigned int subpass) {
    VkShaderModule vertShaderModule = createShaderModule("4_helloCompute/shaders/shader.vert.spv", device->GetVulkanDevice());
    VkShaderModule fragShaderModule = createShaderModule("4_helloCompute/shaders/shader.frag.spv", device->GetVulkanDevice());
...
VkPipeline CreateComputePipeline(VkPipelineLayout pipelineLayout) {
    VkShaderModule compShaderModule = createShaderModule("4_helloCompute/shaders/shader.comp.spv", device->GetVulkanDevice());
